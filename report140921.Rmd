...
# 5. 今回のまとめ
## わかったこと
#### ・売上に寄与する商品グループは大体3グループにわかれそう
#### ・会員は75％
#### ・全データでよく買われるものとFSPを利用して買うものは異なっていた
#### ・1レシートで25％くらいが1個のFSPを利用してる
#### ・FSPは履歴の効果が高い

## to do
#### ・売上が上がった日はなぜかの特定？
#### ・中分類で見ると売上推移がばらついてるので，深堀り。パンだけとか青果ものだけとか。
#### ・場所，エリアの違いとか
#### ・顧客の衰退率の算出
#### ・FSPをやたら使ってる人はやはり多くの商品を買ってくれる（＝有料顧客）かの検証

## なんとなくやれそうなこと
#### ・人のクラスタリング(買う時間，買うモノ，買う量とかで，FSPの利用傾向とかで)
#### ・顧客が衰退しそうなときに効果的だったFSPアイテムの推定とレコメンド方法の検討
#### ・固定客になっていった人がなぜ固定客になったのかのFSPログを用いた検証
